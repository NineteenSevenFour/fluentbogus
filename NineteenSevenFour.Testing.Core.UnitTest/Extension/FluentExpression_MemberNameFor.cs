// <copyright file="FluentExpression_MemberNameFor.cs" company="NineteenSevenFour">
...
namespace NineteenSevenFour.Testing.Core.UnitTest.Extension
{
  ...
  {
    [Fact]
    public void Should_Return_A_String_When_Expression_IsValid()
    {
      // Arrange
    ...
    [Fact]
    public void Should_Throw_ArgumentException_When_Expression_IsNested()
    {
      // Arrange
...
#pragma warning restore IDE0039 // Use local function
    ...
    [Fact]
    public void Should_Throw_ArgumentException_When_Expression_HasInvalidForm()
    {
      // Arrange
