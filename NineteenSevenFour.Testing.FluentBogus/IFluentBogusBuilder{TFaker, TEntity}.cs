// <copyright file="IFluentBogusBuilder{TFaker, TEntity}.cs" company="NineteenSevenFour">
...
/// <summary>
/// <see cref="FluentBogusBuilder{TFaker, TEntity}"/>> provide the methods to finely tweak the fake data generation.
/// </summary>
/// <typeparam name="TFaker">The <see cref="AutoFaker"/> instance that will be used to fake the underlying entity.</typeparam>
  ...
  where TEntity : class
{
  ...
  /// <returns>The <see cref="IFluentBogusBuilder{TFaker,TEntity}"/> instance.</returns>
  IFluentBogusBuilder<TFaker, TEntity> UseFakerConfig(Action<IAutoGenerateConfigBuilder> configBuilder);
  ...
  /// </summary>
  /// <param name="properties">The lambda expression describing the collection property of the <typeparamref name="TEntity"/>.</param>
  /// <returns>The <see cref="IFluentBogusBuilder{TFaker,TEntity}"/> instance.</returns>
  ...
  /// <param name="prop">The lambda expression describing the property of the <typeparamref name="TEntity"/>.</param>
  /// <returns>The <see cref="IFluentBogusBuilder{TFaker,TEntity}"/> instance.</returns>
  ...
  /// </summary>
  /// <typeparam name="TProperty">The type of the property belonging to the <typeparamref name="TEntity"/>.</typeparam>
  /// <typeparam name="TPropEntity">The type of the property of the collection <typeparamref name="TProperty"/> property belonging to the <typeparamref name="TEntity"/>.</typeparam>
