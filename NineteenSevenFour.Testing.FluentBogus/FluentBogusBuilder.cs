// <copyright file="FluentBogusBuilder.cs" company="NineteenSevenFour">
...
{
  /// <summary>
  /// Create a <see cref="FluentBogusBuilder{TEntity}"/> for a <typeparamref name="TEntity"/>> to allow bogus data to be generated.
  /// </summary>
  /// <typeparam name="TEntity">The type of the <typeparamref name="TEntity"/>> to fake.</typeparam>
